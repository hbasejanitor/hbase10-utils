...
public class Rule {
  ...
  public String toString() {
    ...
    buff.append(tableName.toString()).append(" ");
    if (columnFamily != null) {
      buff.append("column family ").append(Bytes.toString(columnFamily));
    }
    if (qualifierStartsWith) {
      buff.append("all qualifiers that start with ");
    }
    if (qualifierEndsWith) {
      buff.append("all qualifiers that end with ");
    }
    if (qualifier != null) {
      buff.append("qualifier ").append(Bytes.toString(qualifier));
    }
  ...
  public void setQualifier(String qualifier) {
    this.setQualifier(Bytes.toBytes(qualifier));
  }
  ...
  public void setTableName(String tableName) {
    this.setTableName(TableName.valueOf(tableName));
  }  
